...
> `// avd · ansible · git · ci/cd · cvaas`

**Level:** ▓▓▓▓░ Advanced

This track covers network automation using Arista AVD, Ansible, and Git-based workflows. If you're deploying campus or data center fabrics and want to automate Day-1 build and Day-2 operations, this is your track.
